...
<head>
    ...
    <title>Edit Jenis Pelanggaran - Admin</title>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.jenis-pelanggaran.update', $jenisPelanggaran->jenis_pelanggaran_id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_pelanggaran') is-invalid @enderror" 
                                           ...
                                           value="{{ old('nama_pelanggaran', $jenisPelanggaran->nama_pelanggaran) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" 
                                           ...
                                           value="{{ old('deskripsi', $jenisPelanggaran->deskripsi) }}">
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('poin') is-invalid @enderror" 
                                           id="poin" name="poin" 
                                           value="{{ old('poin', $jenisPelanggaran->poin) }}" min="1" required>
                                    @error('poin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>

...
<head>
    ...
    <title>Edit Kategori Pelanggaran - Admin</title>
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Edit Kategori Pelanggaran</h1>
    
    <div class="card mb-4">
        <div class="card-header">
            <i class="fas fa-edit me-1"></i>
            Form Edit Kategori Pelanggaran
        </div>
        <div class="card-body">
            <form action="{{ route('admin.kategori-pelanggaran.update', $kategori->kategori_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="color" class="form-control form-control-color @error('warna') is-invalid @enderror" 
                           id="warna" name="warna" value="{{ old('warna', $kategori->warna) }}" required>
                    @error('warna')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>

            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.guru.update', $guru->guru_id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('bidang_studi') is-invalid @enderror" 
                                                   id="bidang_studi" name="bidang_studi" value="{{ old('bidang_studi', $guru->bidang_studi) }}" required>
                                            @error('bidang_studi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="tel" class="form-control @error('no_telp') is-invalid @enderror" 
                                                   id="no_telp" name="no_telp" value="{{ old('no_telp', $guru->no_telp) }}" pattern="[0-9]{10,15}" title="Hanya angka 10-15 digit">
                                            @error('no_telp')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>

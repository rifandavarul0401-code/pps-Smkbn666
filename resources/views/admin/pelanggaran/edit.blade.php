...
<head>
    ...
    <title>Edit Pelanggaran - Admin</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Edit Pelanggaran</h1>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.pelanggaran.update', $pelanggaran->pelanggaran_id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('jenis_pelanggaran_id') is-invalid @enderror" name="jenis_pelanggaran_id" required>
                                        ...
                                        @foreach($jenisPelanggaran as $jp)
                                            <option value="{{ $jp->jenis_pelanggaran_id }}" {{ (old('jenis_pelanggaran_id', $pelanggaran->jenis_pelanggaran_id) == $jp->jenis_pelanggaran_id) ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ old('tanggal', $pelanggaran->tanggal) }}" required>
                                    @error('tanggal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" rows="3">{{ old('keterangan', $pelanggaran->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>

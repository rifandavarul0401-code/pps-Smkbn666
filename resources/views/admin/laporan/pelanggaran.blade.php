                            ...
                            <form method="GET">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="search" class="form-control" placeholder="Nama siswa atau jenis pelanggaran" value="{{ $search }}">
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('admin.laporan.pelanggaran') }}" class="btn btn-secondary">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                {{ $pelanggaran->appends(request()->query())->links('pagination::bootstrap-4', ['class' => 'pagination-sm']) }}
                            </div>
                        </div>
                    </div>
                </div>

...
<head>
    ...
    <title>Tambah Jenis Sanksi - Admin</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tambah Jenis Sanksi</h1>
                    
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-plus me-1"></i>
                            Form Tambah Jenis Sanksi
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.jenis-sanksi.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_sanksi') is-invalid @enderror" name="nama_sanksi" value="{{ old('nama_sanksi') }}" required>
                                    @error('nama_sanksi')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input list="kategori-list" class="form-control @error('kategori') is-invalid @enderror" name="kategori" value="{{ old('kategori') }}" placeholder="Ketik atau pilih kategori" required>

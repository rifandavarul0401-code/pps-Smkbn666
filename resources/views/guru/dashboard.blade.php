            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="page-header mt-4">
                        <h1><i class="fas fa-chalkboard-teacher me-2"></i>Dashboard Guru</h1>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card stat-card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <p class="stat-label mb-1">Pelanggaran Hari Ini</p>
                                            <h2 class="stat-number">{{ $stats['pelanggaran_hari_ini'] }}</h2>
                                        </div>
                                        <div>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ Str::limit($p->jenisPelanggaran->nama_pelanggaran ?? '-', 30) }}</td>
                                ...
                                <div class="card-body">
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $p->siswa->nama_lengkap ?? '-' }}</td>
                                                <td>{{ Str::limit($p->jenisPrestasi->nama_prestasi ?? '-', 30) }}</td>

...
<head>
    <meta charset="utf-8" />
    <title>Input Prestasi - Kesiswaan</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Input Prestasi</h1>
                    
                    <div class="card mt-4">
                        <div class="card-body">
                            <form method="POST" action="{{ route('kesiswaan.prestasi.store') }}">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jenis_prestasi_id" class="form-select" required>
                                        ...
                                        @foreach($jenisPrestasi as $jp)
                                            <option value="{{ $jp->jenis_prestasi_id }}">{{ $jp->nama_prestasi }} - {{ ucfirst($jp->kategori) }} (+{{ $jp->poin }} poin)</option>
                                        @endforeach
                                    </select>
                                </div>

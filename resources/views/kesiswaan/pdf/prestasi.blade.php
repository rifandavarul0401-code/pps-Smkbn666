...
<head>
    <meta charset="utf-8">
    <title>Laporan Prestasi Kesiswaan</title>
    <style>
        body {
...
<body>
    ...
    <div class="info-section">
        ...
        <table style="border: none; margin-bottom: 20px;">
            ...
            <tr style="border: none;">
                ...
                <td style="border: none;">{{ $data->count() }} prestasi</td>
    ...
    @if($data->count() > 0)
        <table>
            <thead>
                <tr>
                    ...
                    <th width="22%">Jenis Prestasi</th>
                    <th width="11%">Tingkat</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $item->tanggal ? $item->tanggal->format('d/m/Y') : ($item->created_at ? $item->created_at->format('d/m/Y') : '-') }}</td>
        ...
        <div style="margin-top: 20px;">
            ...
            <ul>
                <li>Total Prestasi: {{ $data->count() }} prestasi</li>
                <li>Prestasi Terverifikasi: {{ $data->where('status_verifikasi', 'verified')->count() }} prestasi</li>
                <li>Prestasi Pending: {{ $data->where('status_verifikasi', 'pending')->count() }} prestasi</li>
                <li>Prestasi Ditolak: {{ $data->where('status_verifikasi', 'rejected')->count() }} prestasi</li>
                <li>Prestasi Tingkat Nasional: {{ $data->where('tingkat', 'nasional')->count() }} prestasi</li>
                <li>Prestasi Tingkat Provinsi: {{ $data->where('tingkat', 'provinsi')->count() }} prestasi</li>
                <li>Prestasi Tingkat Kabupaten: {{ $data->where('tingkat', 'kabupaten')->count() }} prestasi</li>
            </ul>
        </div>
    @else
